...
def main():
    ...
    P_paths = []
    for tag in TAGS:
        P_paths.append(f"{args.work_dir}/models/xtransformer/{args.dataset}/{args.model_name}/{args.feature_name}/XYstack/downstream/{tag}/{args.Pk}/{L_option}/P.20.npz")
        
    Y_true = sorted_csr(load_matrix(f"{args.work_dir}/dataset/{args.dataset}/normalized/Y.tst.npz").tocsr())
    ...
    PATH = f"{args.work_dir}/models/xtransformer/{args.dataset}/{args.model_name}/{args.feature_name}/XYstack/downstream/{args.DS_model_names}/{args.Pk}/{args.L_option}"
