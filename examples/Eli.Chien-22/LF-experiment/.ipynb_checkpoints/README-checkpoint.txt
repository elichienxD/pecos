...
4. Run `python3 pecos_dataform_full.py --dataset ${dataset}` for text preprocessing.
...
2. Run `./xrtransformer.sh ${model_name} ${feature_name} ${dataset}`. The results will be saved under `./models`.
```
