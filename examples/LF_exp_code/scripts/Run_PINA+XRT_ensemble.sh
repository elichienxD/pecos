...
python3 PINA_augmentation.py --model_name v0-raw-pre --feature_name BoW --dataset $dataset --L_option Lft_xrt --Pk 5
...
python3 Ensemble-PINA.py --dataset $dataset \
                    --model_name v0-raw-pre\
                    --DS_model_names v0-raw-s0,v0-raw-s1,v0-raw-s2 \
                    --feature_name BoW \
                    --ens_name softmax

ENS_path="./models_LF/xtransformer/${dataset}/v0-raw-s0,v0-raw-s1,v0-raw-s2/BoW"
